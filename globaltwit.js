    ...
    Tstream.on('data', async function (tweet) {
        try{
            ...
            if (tweet.retweeted === true || tweet.text.startsWith('RT')) {
                if (account_params[tweet.user.screen_name].retweet === true){
                    if (debug === true) client.shard.send(debug_header + `Retweet from @${tweet.retweeted_status.user.screen_name}`)
                    embed   .setColor(account_params[tweet.user.screen_name].embed_color ? account_params[tweet.user.screen_name].embed_color : 'RANDOM')
                    ...
                    if (client.channels.some(c=>c.id == account_params[tweet.user.screen_name].channel)) {
                        var webhooks = await client.channels.find(c=>c.id == account_params[tweet.user.screen_name].channel).fetchWebhooks()
                        .catch(client.channels.find(c=>c.id == account_params[tweet.user.screen_name].channel).createWebhook(client.user.username)
                        .then(async wh=>{
                        ...
                        webhooks = await client.channels.find(c=>c.id == account_params[tweet.user.screen_name].channel).fetchWebhooks()
                ...
                if (tweet.in_reply_to_status_id == null || tweet.in_reply_to_user_id == null) {
                    ...
                    if (account_params[tweet.user.screen_name].reply === false){
            ...
            if (client.channels.some(c=>c.id == account_params[tweet.user.screen_name].channel)) client.channels.find(c=>c.id == account_params[tweet.user.screen_name].channel).send(`https://twitter.com/${tweet.user.screen_name}/status/${tweet.id_str}`)
